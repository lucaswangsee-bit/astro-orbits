...
export const STARS = [
  {
    ...
    mechanics: {
      ...
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1}{(1)^2} \approx 274\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from its catalog coordinates RA = 14.50 h, Dec = −62.68°, distance = 4.24 ly. RA (hours) and Dec (degrees) are converted to radians, then mapped to 3D by \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Being the nearest star, it lies closest to the origin of any point on the map.`,
      gValue: 'Surface gravity g ≈ 1410 m/s² (about 144 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.12}{(0.15)^2} \approx 1410\,\mathrm{m/s^2}`,
      gNote: 'A tiny, dense red dwarf packs a surprisingly strong surface gravity.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 14.66 h, Dec = −60.83°, distance = 4.37 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). It is gravitationally bound in a triple system, so its true position drifts slowly over centuries; this map is a fixed J2000 snapshot.`,
      gValue: 'Surface gravity g ≈ 199 m/s² (about 20 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.08}{(1.22)^2} \approx 199\,\mathrm{m/s^2}`,
      gNote: 'Sun-like, so its gravity is close to the Sun’s.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 17.96 h, Dec = +4.69°, distance = 5.96 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). It has the largest proper motion of any star, so its RA/Dec measurably shift year to year — this position is a snapshot for the J2000 epoch.`,
      gValue: 'Surface gravity g ≈ 1210 m/s² (about 124 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.16}{(0.19)^2} \approx 1210\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 6.75 h, Dec = −16.72°, distance = 8.66 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). The coordinates track the bright primary Sirius A; its white-dwarf companion Sirius B orbits too close to separate at this scale.`,
      gValue: 'Surface gravity g ≈ 193 m/s² (about 20 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{2.06}{(1.71)^2} \approx 193\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 7.66 h, Dec = +5.23°, distance = 11.46 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 98 m/s² (about 10 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.5}{(2.05)^2} \approx 98\,\mathrm{m/s^2}`,
      gNote: 'It is swelling into a subgiant, so its surface gravity has already dropped well below the Sun’s.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 1.73 h, Dec = −15.94°, distance = 11.9 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 342 m/s² (about 35 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.78}{(0.79)^2} \approx 342\,\mathrm{m/s^2}`,
      gNote: 'A slightly smaller Sun-like star, so it is a touch denser and its gravity a bit higher.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 19.85 h, Dec = +8.87°, distance = 16.73 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its extreme rotation makes it visibly oblate, so the “radius” used below is an equatorial average.`,
      gValue: 'Surface gravity g ≈ 151 m/s² (about 15 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.8}{(1.8)^2} \approx 151\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 18.62 h, Dec = +38.78°, distance = 25.04 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 105 m/s² (about 11 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{2.14}{(2.36)^2} \approx 105\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 22.96 h, Dec = −29.62°, distance = 25.13 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 155 m/s² (about 16 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.92}{(1.84)^2} \approx 155\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 7.76 h, Dec = +28.03°, distance = 33.78 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 6.8 m/s² (about 0.7 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.9}{(8.8)^2} \approx 6.8\,\mathrm{m/s^2}`,
      gNote: 'As an orange giant it has puffed up, so despite ~2 solar masses its surface gravity is below Earth’s.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 14.26 h, Dec = +19.18°, distance = 36.7 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). It races through the solar neighborhood, so over long timescales its map position shifts noticeably.`,
      gValue: 'Surface gravity g ≈ 0.46 m/s² (about 0.05 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.08}{(25)^2} \approx 0.46\,\mathrm{m/s^2}`,
      gNote: 'Its huge, bloated envelope leaves only a feeble surface gravity.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 4.60 h, Dec = +16.51°, distance = 65.3 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 0.16 m/s² (about 0.017 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{1.16}{(44)^2} \approx 0.16\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 5.92 h, Dec = +7.41°, distance ≈ 548 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its distance is uncertain by ~20%, so its radial position on the map is the least certain of these stars.`,
      gValue: 'Surface gravity g ≈ 0.008 m/s² (about 0.0008 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{16.5}{(760)^2} \approx 0.008\,\mathrm{m/s^2}`,
      gNote: 'A supergiant so vast its outer layers are barely bound — the surface gravity is almost negligible.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 16.49 h, Dec = −26.43°, distance ≈ 604 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 0.007 m/s² (about 0.0007 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{12}{(680)^2} \approx 0.007\,\mathrm{m/s^2}`,
      gNote: 'Like Betelgeuse, a bloated supergiant with a vanishingly weak surface pull.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 5.24 h, Dec = −8.20°, distance ≈ 863 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). It is the most distant star in this map, so it defines its outer edge.`,
      gValue: 'Surface gravity g ≈ 0.9 m/s² (about 0.09 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{21}{(79)^2} \approx 0.9\,\mathrm{m/s^2}`,
      gNote: 'A blue supergiant is more compact than the red supergiants, so its gravity is far higher than theirs — though still below Earth’s.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 10.94 h, Dec = +7.03°, distance = 7.86 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). It sits among the innermost points of the map as one of the Sun’s closest neighbors.`,
      gValue: 'Surface gravity g ≈ 1450 m/s² (about 148 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.11}{(0.144)^2} \approx 1450\,\mathrm{m/s^2}`,
      gNote: 'A very small, dense red dwarf, so its surface gravity is enormous.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 11.06 h, Dec = +35.98°, distance = 8.30 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its large proper motion means its RA/Dec drift measurably over decades; this is a J2000 snapshot.`,
      gValue: 'Surface gravity g ≈ 700 m/s² (about 72 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.39}{(0.39)^2} \approx 700\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 3.55 h, Dec = −9.46°, distance = 10.48 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\).`,
      gValue: 'Surface gravity g ≈ 416 m/s² (about 42 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.82}{(0.735)^2} \approx 416\,\mathrm{m/s^2}`,
      gNote: 'A slightly smaller, denser cousin of the Sun, so its gravity is a bit higher.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 21.11 h, Dec = +38.74°, distance = 11.4 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its famously high proper motion shifts its coordinates over the years; this is a J2000 snapshot.`,
      gValue: 'Surface gravity g ≈ 370 m/s² (about 38 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.70}{(0.72)^2} \approx 370\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 22.06 h, Dec = −56.79°, distance = 11.87 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its high proper motion drifts these coordinates over decades; this is a J2000 snapshot.`,
      gValue: 'Surface gravity g ≈ 421 m/s² (about 43 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{0.78}{(0.71)^2} \approx 421\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 5.28 h, Dec = +46.00°, distance = 42.9 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Coordinates track the bright giant pair, whose two stars orbit too close to separate at this scale.`,
      gValue: 'Surface gravity g ≈ 4.95 m/s² (about 0.5 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{2.69}{(12.2)^2} \approx 4.95\,\mathrm{m/s^2}`,
      gNote: 'As a swollen giant its surface gravity is only about half of Earth’s despite its large mass.'
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 7.58 h, Dec = +31.89°, distance = 51.5 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Coordinates track the bright A-star; the other five members are unresolved at this scale.`,
      gValue: 'Surface gravity g ≈ 114 m/s² (about 12 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{2.2}{(2.3)^2} \approx 114\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 10.14 h, Dec = +11.97°, distance = 79 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its extreme rotation makes it oblate, so the radius below is an equatorial-average value.`,
      gValue: 'Surface gravity g ≈ 109 m/s² (about 11 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{3.8}{(3.09)^2} \approx 109\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 3.14 h, Dec = +40.96°, distance = 90 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Coordinates track the bright primary; the eclipsing companion orbits too close to separate at this scale.`,
      gValue: 'Surface gravity g ≈ 117 m/s² (about 12 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{3.17}{(2.73)^2} \approx 117\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 13.42 h, Dec = −11.16°, distance ≈ 250 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Coordinates track the bright primary; its close companion is unresolved at this scale.`,
      gValue: 'Surface gravity g ≈ 51 m/s² (about 5 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{10.3}{(7.4)^2} \approx 51\,\mathrm{m/s^2}`
    }
  },
  {
    ...
    mechanics: {
      orbit: String.raw`Placed from RA = 2.53 h, Dec = +89.26°, distance ≈ 433 ly via \(x = d\cos(\mathrm{Dec})\cos(\mathrm{RA}),\ y = d\cos(\mathrm{Dec})\sin(\mathrm{RA}),\ z = d\sin(\mathrm{Dec})\). Its declination of nearly +90° places it almost straight along the map’s polar (z) axis, mirroring how it sits over Earth’s north pole.`,
      gValue: 'Surface gravity g ≈ 1.0 m/s² (about 0.1 × Earth)',
      gCalc: String.raw`g = g_\odot\,\dfrac{M/M_\odot}{(R/R_\odot)^2} = (274\,\mathrm{m/s^2})\,\dfrac{5.13}{(37.5)^2} \approx 1.0\,\mathrm{m/s^2}`,
      gNote: 'As a bloated supergiant, its surface gravity is only about a tenth of Earth’s despite its large mass.'
    }
  }
];
